...
<script>
import { listInfo, getInfo, delInfo, addInfo, updateInfo } from "@/api/music/info";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('music/info/export', {
        ...this.queryParams
